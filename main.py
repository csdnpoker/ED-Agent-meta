...
RAW_TASKS = [
    ...
    {"id": 21, "content": "写一篇关于人工智能发展史的短文，并用英文总结其未来趋势。"},
    {"id": 22, "content": "计算2024年中国GDP增长率，并用中文解释其影响。"},
    {"id": 23, "content": "润色以下英文段落并总结其主要观点：Artificial intelligence is transforming industries worldwide."},
    {"id": 24, "content": "分析气候变化对农业的影响，生成一段分析报告并润色。"},
    {"id": 25, "content": "生成一段关于区块链技术的介绍，推理其在金融领域的应用，并总结。"},
    {"id": 26, "content": "计算斐波那契数列第20项，并用英文解释其计算过程。"},
    {"id": 27, "content": "对以下技术文档进行语法润色和分析总结：The system architecture consists of multiple agents."},
    {"id": 28, "content": "生成一段关于未来交通的畅想，润色后分析其可行性并总结。"},
    {"id": 29, "content": "计算2025/1/1距离今天多少天，并用英文解释其意义。"},
    {"id": 30, "content": "写一段关于健康生活的建议，润色并总结其核心要点。"},
    {"id": 31, "content": "生成一段关于机器学习的介绍，推理其在医疗领域的潜力，并用中文总结。"},
    {"id": 32, "content": "对以下段落进行语法润色和分析：Data privacy is a major concern in cloud computing."},
    {"id": 33, "content": "写一篇关于新能源车市场的分析报告，并用英文总结其发展趋势。"},
    {"id": 34, "content": "计算圆周率到小数点后10位，并用中文解释其计算方法。"},
    {"id": 35, "content": "生成一段关于5G技术的介绍，分析其对社会的影响并总结。"},
    {"id": 36, "content": "对以下英文句子进行语法润色并总结其含义：The quick brown fox jumps over the lazy dog."},
    {"id": 37, "content": "写一段关于可持续发展的建议，推理其对环境的益处并总结。"},
    {"id": 38, "content": "分析人工智能在教育领域的应用，生成一段分析并润色。"},
    {"id": 39, "content": "计算100以内所有质数的和，并用英文解释其意义。"},
    {"id": 40, "content": "生成一段关于数字货币的介绍，分析其风险并用中文总结。"},
    {"id": 41, "content": "写一篇关于人工智能发展史的短文，并用英文总结其未来趋势。"},
    {"id": 42, "content": "计算2024年中国GDP增长率，并用中文解释其影响。"},
    {"id": 43, "content": "润色以下英文段落并总结其主要观点：Artificial intelligence is transforming industries worldwide."},
    {"id": 44, "content": "分析气候变化对农业的影响，生成一段分析报告并润色。"},
    {"id": 45, "content": "生成一段关于区块链技术的介绍，推理其在金融领域的应用，并总结。"},
    {"id": 46, "content": "计算斐波那契数列第20项，并用英文解释其计算过程。"},
    {"id": 47, "content": "对以下技术文档进行语法润色和分析总结：The system architecture consists of multiple agents."},
    {"id": 48, "content": "生成一段关于未来交通的畅想，润色后分析其可行性并总结。"},
    {"id": 49, "content": "计算2025/1/1距离今天多少天，并用英文解释其意义。"},
    {"id": 50, "content": "写一段关于健康生活的建议，润色并总结其核心要点。"},
    {"id": 51, "content": "生成一段关于机器学习的介绍，推理其在医疗领域的潜力，并用中文总结。"},
    {"id": 52, "content": "对以下段落进行语法润色和分析：Data privacy is a major concern in cloud computing."},
    {"id": 53, "content": "写一篇关于新能源车市场的分析报告，并用英文总结其发展趋势。"},
    {"id": 54, "content": "计算圆周率到小数点后10位，并用中文解释其计算方法。"},
    {"id": 55, "content": "生成一段关于5G技术的介绍，分析其对社会的影响并总结。"},
    {"id": 56, "content": "对以下英文句子进行语法润色并总结其含义：The quick brown fox jumps over the lazy dog."},
    {"id": 57, "content": "写一段关于可持续发展的建议，推理其对环境的益处并总结。"},
    {"id": 58, "content": "分析人工智能在教育领域的应用，生成一段分析并润色。"},
    {"id": 59, "content": "计算100以内所有质数的和，并用英文解释其意义。"},
    {"id": 60, "content": "生成一段关于数字货币的介绍，分析其风险并用中文总结。"},
    {"id": 61, "content": "写一篇关于人工智能发展史的短文，并用英文总结其未来趋势。"},
    {"id": 62, "content": "计算2024年中国GDP增长率，并用中文解释其影响。"},
    {"id": 63, "content": "润色以下英文段落并总结其主要观点：Artificial intelligence is transforming industries worldwide."},
    {"id": 64, "content": "分析气候变化对农业的影响，生成一段分析报告并润色。"},
    {"id": 65, "content": "生成一段关于区块链技术的介绍，推理其在金融领域的应用，并总结。"},
    {"id": 66, "content": "计算斐波那契数列第20项，并用英文解释其计算过程。"},
    {"id": 67, "content": "对以下技术文档进行语法润色和分析总结：The system architecture consists of multiple agents."},
    {"id": 68, "content": "生成一段关于未来交通的畅想，润色后分析其可行性并总结。"},
    {"id": 69, "content": "计算2025/1/1距离今天多少天，并用英文解释其意义。"},
    {"id": 70, "content": "写一段关于健康生活的建议，润色并总结其核心要点。"},
    {"id": 71, "content": "生成一段关于机器学习的介绍，推理其在医疗领域的潜力，并用中文总结。"},
    {"id": 72, "content": "对以下段落进行语法润色和分析：Data privacy is a major concern in cloud computing."},
    {"id": 73, "content": "写一篇关于新能源车市场的分析报告，并用英文总结其发展趋势。"},
    {"id": 74, "content": "计算圆周率到小数点后10位，并用中文解释其计算方法。"},
    {"id": 75, "content": "生成一段关于5G技术的介绍，分析其对社会的影响并总结。"},
    {"id": 76, "content": "对以下英文句子进行语法润色并总结其含义：The quick brown fox jumps over the lazy dog."},
    {"id": 77, "content": "写一段关于可持续发展的建议，推理其对环境的益处并总结。"},
    {"id": 78, "content": "分析人工智能在教育领域的应用，生成一段分析并润色。"},
    {"id": 79, "content": "计算100以内所有质数的和，并用英文解释其意义。"},
    {"id": 80, "content": "生成一段关于数字货币的介绍，分析其风险并用中文总结。"},
    {"id": 81, "content": "写一篇关于人工智能发展史的短文，并用英文总结其未来趋势。"},
    {"id": 82, "content": "计算2024年中国GDP增长率，并用中文解释其影响。"},
    {"id": 83, "content": "润色以下英文段落并总结其主要观点：Artificial intelligence is transforming industries worldwide."},
    {"id": 84, "content": "分析气候变化对农业的影响，生成一段分析报告并润色。"},
    {"id": 85, "content": "生成一段关于区块链技术的介绍，推理其在金融领域的应用，并总结。"},
    {"id": 86, "content": "计算斐波那契数列第20项，并用英文解释其计算过程。"},
    {"id": 87, "content": "对以下技术文档进行语法润色和分析总结：The system architecture consists of multiple agents."},
    {"id": 88, "content": "生成一段关于未来交通的畅想，润色后分析其可行性并总结。"},
    {"id": 89, "content": "计算2025/1/1距离今天多少天，并用英文解释其意义。"},
    {"id": 90, "content": "写一段关于健康生活的建议，润色并总结其核心要点。"},
    {"id": 91, "content": "生成一段关于机器学习的介绍，推理其在医疗领域的潜力，并用中文总结。"},
    {"id": 92, "content": "对以下段落进行语法润色和分析：Data privacy is a major concern in cloud computing."},
    {"id": 93, "content": "写一篇关于新能源车市场的分析报告，并用英文总结其发展趋势。"},
    {"id": 94, "content": "计算圆周率到小数点后10位，并用中文解释其计算方法。"},
    {"id": 95, "content": "生成一段关于5G技术的介绍，分析其对社会的影响并总结。"},
    {"id": 96, "content": "对以下英文句子进行语法润色并总结其含义：The quick brown fox jumps over the lazy dog."},
    {"id": 97, "content": "写一段关于可持续发展的建议，推理其对环境的益处并总结。"},
    {"id": 98, "content": "分析人工智能在教育领域的应用，生成一段分析并润色。"},
    {"id": 99, "content": "计算100以内所有质数的和，并用英文解释其意义。"},
    {"id": 100, "content": "生成一段关于数字货币的介绍，分析其风险并用中文总结。"},
]
